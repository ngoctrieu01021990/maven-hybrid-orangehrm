...
public class BaseTest {
    ...
    //CLOUD: SauceLab
    protected WebDriver getBrowserDriverSauceLab(String appURL, String platformName, String browserName, String browserVersion) {
    ...
    //CLOUD: BITBAR
    protected WebDriver getBrowserDriverBitBar(String appURL, String platformName, String platformVersion, String browserName, String browserVersion) {
        MutableCapabilities capabilities = new MutableCapabilities();
    ...
    //CLOUD: Lambda
    protected WebDriver getBrowserDriverLambda(String appURL, String platformName, String browserName, String browserVersion) {
        MutableCapabilities capability = null;
        browserName = browserName.toLowerCase();
    ...
    protected WebDriver getBrowserDriver(String environmentName, String url, String osName, String osVersion, String browserName, String browserVersion, String ipAddress, String portNumber) {
        ...
        switch (environmentList) {
            ...
            case BROWSERSTACK:
                ...
                break;
            case SAUCELAB:
                driver = new SaucelabEnvironmentManager(osName, browserName, browserVersion).createDriver();
                break;
            case BITBAR:
                driver = new BitbarEnvironmentManager(osName, osVersion, browserName, browserVersion).createDriver();
                break;
            case LAMBDA:
                driver = new LambdaEnvironmentManager(osName, browserName, browserVersion).createDriver();
                break;
            case DEVICEFARM:
                driver = new DeviceFarmEnvironmentManager(osName, browserName, browserVersion).createDriver();
                break;
            default:
